...
INSERT INTO huesped (id_huesped, nombre, apellido, dni, historial, telefono) VALUES
(1, 'Carlos', 'Mendoza', '70111222', 'Sin observaciones', '958111222'),
(2, 'Lucia', 'Torres', '70222333', 'Cliente frecuente', '958222333'),
(3, 'Mario', 'Ramos', '70333444', 'Solicita habitacion tranquila', '958333333'),
(4, 'Ana', 'Flores', '70444555', 'Sin observaciones', '958444555'),
(5, 'Jorge', 'Quispe', '70555666', 'Pagos puntuales', '958555666');

INSERT INTO habitacion (id_habitacion, numero_habitacion, piso, capacidad, precio_base, id_estado) VALUES
(1, 101, 1, 2, 150.00, 1),
(2, 102, 1, 2, 150.00, 1),
(3, 201, 2, 3, 220.00, 2),
(4, 202, 2, 4, 300.00, 5),
...
INSERT INTO reserva (id_reserva, fch_reserva, estado_reserva, cantidad_personas, id_huesped, id_habitacion, id_empleado) VALUES
...
INSERT INTO consumo_srvicio (id_consumo_srvc, fch_consumo, cantidad, sub_total, descripcion, id_estadia, id_servicio, id_empleado) VALUES
(1, '2026-05-10', 1, 15.00, 'Hospedaje habitacion simple', 1, 1, 1),
(2, '2026-05-11', 1, 30.00, 'Hospedaje habitacion doble', 2, 2, 2),
(3, '2026-05-12', 2, 16.00, 'Consumo de minibar', 2, 3, 2),
(4, '2026-05-13', 1, 20.00, 'Acceso a spa', 4, 4, 3),
(5, '2026-05-14', 1, 15.00, 'Almuerzo ejecutivo', 5, 5, 2);
...
INSERT INTO pago (id_pago, fch_pago, monto_total, estado_pago, id_reserva, id_metodo) VALUES
...
INSERT INTO detalle_pago (id_detalle, monto_abonado, descripcion, id_pago, id_servicio) VALUES
...
INSERT INTO comprobante (id_comprobante, serie, fch_emision, descripcion, id_pago) VALUES
...
INSERT INTO mantenimiento (id_mantenimiento, fch_inicio, fch_fin, motivo, descripcion, estado_mantenimiento, costo, id_habitacion, id_empleado) VALUES
(1, '2025-01-05', '2025-01-06', 'Fuga de agua', 'Reparacion de tuberia en el bano', 'Finalizado', 120.00, 5, 4),
...
(5, '2025-04-01', '2025-04-03', 'Electrico', 'Revision del cableado', 'Finalizado', 150.00, 2, 4);
